...
This documentation covers the instruction on how to use and use the Bootstrap templates, and answers to any common problems and issues you may face while using the templates.
