          ...
          <div className="flex flex-wrap gap-8 md:flex-nowrap md:items-center md:justify-between md:gap-0">
            ...
            >
              <h2 className="mb-4 w-11/12 text-3xl font-bold text-black dark:text-white xl:text-sectiontitle4">
                Unlock the Latest in Digital Innovation
              </h2>
              <p>
               Subscribe to the Socio Newsletter and be the first to receive exclusive updates, industry insights, and valuable tips directly in your inbox
              </p>
            </motion.div>
            <motion.div
              variants={{
